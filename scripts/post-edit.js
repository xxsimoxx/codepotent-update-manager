...
jQuery(document).ready(function($) {
	...
	function get_default_text_with_example_data() {
		var text = '';
		text += '=== Plugin Name ===\n\n';
		text += 'Description:       A succinct description of the plugin; shown in the plugin admin row. Text added here must be a single, unbroken line.\n';
		text += 'Version:           1.0.0\n';
		text += 'Text Domain:       plugin-folder-name\n';
		...
		text += 'A succinct description of the plugin; shown in the plugin admin row. Text added here must be a single, unbroken line.\n\n';
		text += '== Description ==\n\n';
		text += '# Sell the _sizzle_, not the _steak_!\n\n';
		text += 'Since this is the first view your users might see, use it to describe the top features and benefits of your plugin. Avoid the temptation of placing every last detail here. Give your reader a reason to click through the other tabs and see exactly _why_ they need your plugin.\n\n';
		text += '# Give your plugin details some flair!\n\n';
