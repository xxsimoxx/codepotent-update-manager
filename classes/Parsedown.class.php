...
/**
 * -----------------------------------------------------------------------------
 * Purpose: Convert markdown to markup.
 * Package: CodePotent\UpdateManager\Parsedown
 * Version: 1.7.3
 * Author: Emanuil Rusev
 * Author URI: https://parsedown.org/
 * -----------------------------------------------------------------------------
 * Copyright © 2019 - Emanuil Rusev
 * -----------------------------------------------------------------------------
 * Adapted by John Alarcon, https://codepotent.com
 * -----------------------------------------------------------------------------
 */
